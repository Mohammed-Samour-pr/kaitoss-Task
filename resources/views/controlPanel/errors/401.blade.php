...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" >
        <!--begin::Content-->
        <h1 class="font-weight-boldest text-dark mt-15 text-center" style="font-size: 3rem">خطأ في الصلاحيات</h1>
        <p class="font-size-h3  font-weight-normal text-center " style="color:red" >
            يرجى منك التأكد من صلاحيات الدخول من مسئول النظام
            <br>
            <a href="{{ url('http://apps.moh.gov.ps/') }}" >العودة للصفحة الرئيسية</a>
