...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" >
        <!--begin::Content-->
        <h1 class="font-weight-boldest text-dark-75 mt-15 text-center" style="font-size: 10rem">404</h1>
        <p class="font-size-h3  font-weight-normal text-center " style="color:red" >
            OOPS! Something went wrong here <a href="{{ url('http://apps.moh.gov.ps/') }}" >BackToHome</a>
        </p>
