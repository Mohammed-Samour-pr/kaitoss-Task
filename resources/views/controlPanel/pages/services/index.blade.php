                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" action="{{ route('services.update','test')}}" method="post"
                    ...
                    <div class="modal fade" id="Deleteservices" data-backdrop="static" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" action="{{ route('services.destroy','test')}}" method="post"
                                          enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        @method('Delete')
                                        <div class="card-body">
